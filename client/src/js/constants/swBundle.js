/**
 * Hằng số Service Worker (importScripts — không dùng ES module).
 * Đồng bộ với `serviceWorker.js` trong cùng thư mục.
 */
/* global SW_CACHE_NAME, SW_APP_SHELL, SW_OFFLINE_FALLBACK */
const SW_CACHE_NAME = "drive-school-v5";
const SW_OFFLINE_FALLBACK = "/exam.html";
const SW_APP_SHELL = [
  "/",
  "/index.html",
  "/login.html",
